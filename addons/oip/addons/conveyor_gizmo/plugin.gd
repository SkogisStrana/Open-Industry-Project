...
const ConveyorGizmoPlugin = preload("res://addons/oip/addons/conveyor_gizmo/conveyor_gizmo_plugin.gd")
const PathBeltGizmoPlugin = preload("res://addons/oip/addons/conveyor_gizmo/path_belt_gizmo_plugin.gd")
const CurvedConveyorGizmoPlugin = preload("res://addons/oip/addons/conveyor_gizmo/curved_conveyor_gizmo_plugin.gd")
