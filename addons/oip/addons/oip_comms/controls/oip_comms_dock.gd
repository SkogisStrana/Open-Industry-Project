...
const TAG_GROUP = preload("res://addons/oip/addons/oip_comms/controls/tag_group.tscn")
const _SERVICE_SCRIPT: GDScript = preload("res://addons/oip/src/comms/oip_comms_service.gd")
