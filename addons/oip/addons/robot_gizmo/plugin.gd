...
const ROBOT_SCRIPT_PATH := "res://addons/oip/src/SixAxisRobot/six_axis_robot.gd"
...
func _enter_tree() -> void:
	gizmo_plugin = preload("res://addons/oip/addons/robot_gizmo/robot_gizmo_plugin.gd").new()
