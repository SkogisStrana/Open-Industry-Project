...
func _ready() -> void:
	...
	load_library(get_or_create_project_setting(PROJECT_SETTING_CURRENT_LIBRARY_PATH, "res://addons/oip/addons/scene-library/scene_library.cfg"))
...
func _get_or_create_thumbnail(id: int, path: String) -> ImageTexture:
	...
	if _cache_enabled and FileAccess.file_exists(cache_path):
		...
		const THUMB_PLACEHOLDER_PATH: String = "res://addons/oip/addons/scene-library/icons/thumb_placeholder.svg"
