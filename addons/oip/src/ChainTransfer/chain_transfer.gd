...
var _chain_transfer_base_scene: PackedScene = load("res://addons/oip/src/ChainTransfer/Base.tscn")
...
func _get_custom_preview_node() -> Node3D:
	var preview_scene := load("res://addons/oip/parts/ChainTransfer.tscn") as PackedScene
