...
const BELT_TEXTURE: Texture2D = preload("res://addons/oip/assets/3DModels/Textures/4K-fabric_39-diffuse.jpg")
const BELT_TEXTURE_ALT: Texture2D = preload("res://addons/oip/assets/3DModels/Textures/ConvBox_Conv_text__arrows_1024.png")
...
static func create_material(color: Color, texture_style: int) -> ShaderMaterial:
	...
	material.set_shader_parameter("use_alternate_texture", texture_style == BeltConveyor.BeltTexture.ALTERNATE)
