...
const BELT_SHADER: Shader = preload("res://addons/oip/src/Conveyor/belt_surface_shader.gdshader")
...
@export var leg_model_scene: PackedScene = preload("res://addons/oip/parts/ConveyorLegC.tscn"):
	set(value):
...
func _get_custom_preview_node() -> Node3D:
	var preview_scene := load("res://addons/oip/parts/CurvedBeltConveyor.tscn") as PackedScene
...
static var _belt_texture_res: Texture2D = preload("res://addons/oip/assets/3DModels/Textures/4K-fabric_39-diffuse.jpg")
static var _belt_texture_alt: Texture2D = preload("res://addons/oip/assets/3DModels/Textures/ConvBox_Conv_text__arrows_1024.png")
