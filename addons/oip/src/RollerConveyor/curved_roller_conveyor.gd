...
const CORNER_MESH_PATH := "res://addons/oip/assets/3DModels/Meshes/ConveyorRollerRollerCorner_Cylinder_002.res"
...
func _get_custom_preview_node() -> Node3D:
	var preview_scene := load("res://addons/oip/parts/CurvedRollerConveyor.tscn") as PackedScene
...
func _takeover_roller_material() -> StandardMaterial3D:
	return load("res://addons/oip/assets/3DModels/Materials/Metall2.tres").duplicate(true) as StandardMaterial3D
