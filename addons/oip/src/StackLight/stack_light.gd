...
var _segment_scene: PackedScene = load("res://addons/oip/src/StackLight/StackSegment.tscn")
var _data: StackLightData = load("res://addons/oip/src/StackLight/StackLightData.tres")
